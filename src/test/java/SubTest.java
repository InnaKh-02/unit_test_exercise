...
public class SubTest extends Conditionals {
    ...
    @Execution(ExecutionMode.CONCURRENT)
    @Test
    void testSubLongUnderflow() {
        assertThrows(ArithmeticException.class, () -> calculator.sub(Long.MIN_VALUE, 1));
    }

    @Execution(ExecutionMode.CONCURRENT)
    @Test
    void testSubLongOverflow() {
        assertThrows(ArithmeticException.class, () -> calculator.sub(Long.MAX_VALUE, -1));
    }
}